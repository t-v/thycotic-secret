...
ADD dist/ansible_runner-1.3.1-py2.py3-none-any.whl /ansible_runner-1.3.1-py2.py3-none-any.whl
# In OpenShift, container will run as a random uid number and gid 0. Make sure things
# are writeable by the root group.
RUN chmod 755 /entrypoint.sh && chmod -R g+w /runner && chgrp -R root /runner && \
    chmod g+w /etc/passwd && \
    pip install --no-cache-dir /ansible_runner-1.3.1-py2.py3-none-any.whl
